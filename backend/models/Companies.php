 ...
 * @property string $company_inception
...
class Companies extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['company_name', 'company_email', 'company_address', 'company_created_date', 'company_inception', 'company_status'], 'required'],
            [['company_created_date', 'company_inception'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'company_inception' => 'Company Inception',
